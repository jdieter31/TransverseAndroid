...
public class Text {
    ...
    public void refresh() {
        textImage = new Image();
        textImage.setTextureHandle(font.textureHandle);
        font.calculateDataForString(text, textSize, originX, originY, originZ);
        textImage.setUVCoordinates(font.getUVCoordinates());
        textImage.setDrawOrder(font.getDrawOrder());
        textImage.setVertices(font.getVertices());
        textImage.refresh();
    }

    public void draw(int verticeHandle, int uvCoordinateHandle, int textureVariableHandle) {
        textImage.draw(verticeHandle, uvCoordinateHandle, textureVariableHandle);
    }
